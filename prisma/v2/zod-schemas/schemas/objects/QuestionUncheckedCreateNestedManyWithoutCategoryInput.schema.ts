...
const Schema: z.ZodType<Prisma.QuestionUncheckedCreateNestedManyWithoutCategoryInput> =
  z.union([
    z
      .object({
        create: z
...
export const QuestionUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
