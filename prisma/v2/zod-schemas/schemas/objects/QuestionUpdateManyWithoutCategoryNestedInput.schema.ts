...
const Schema: z.ZodType<Prisma.QuestionUpdateManyWithoutCategoryNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const QuestionUpdateManyWithoutCategoryNestedInputObjectSchema = Schema;
