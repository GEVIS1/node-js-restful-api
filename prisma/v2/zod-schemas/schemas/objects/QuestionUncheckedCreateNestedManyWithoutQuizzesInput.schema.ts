...
const Schema: z.ZodType<Prisma.QuestionUncheckedCreateNestedManyWithoutQuizzesInput> =
  z.union([
    z
      .object({
        create: z
...
export const QuestionUncheckedCreateNestedManyWithoutQuizzesInputObjectSchema =
  Schema;
