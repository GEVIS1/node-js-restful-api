...
const Schema: z.ZodType<Prisma.QuizUncheckedUpdateManyWithoutQuestionsNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const QuizUncheckedUpdateManyWithoutQuestionsNestedInputObjectSchema =
  Schema;
